<?php
  ...
  function GetYoubi($num){
    ...
    if($num%7==5){
      $res = '<br><div class="w saturday"> ('.$IItableday[$num%7].')'.'</div>';
    }else if($num%7==6){
      $res = '<br><div class="w sunday"> ('.$IItableday[$num%7].')'.'</div>';
    }else{
      $res = '<br><div class="w"> ('.$IItableday[$num%7].')'.'</div>';
    }
    return $res;
  }
  ...
  function Charendar($res,$i){
    ...
    if($i==1){
      ...
      $ans='<section class="sheet"></section><section class="sheet"></section>';
    }
